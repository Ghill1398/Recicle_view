...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new Alumno("Anita ", "La huerfanita "));
        datos.add(new Alumno("Francisco ", "Lorin Colorado "));
        datos.add(new Alumno("Adolf ", "Hitler "));
        datos.add(new Alumno("David ", "Eugenio "));
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datos.add(1, new Alumno("Nuevo Alumno", "Subtitulo nuevo alumno"));
